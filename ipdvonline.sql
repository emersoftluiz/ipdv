...
--
-- Host: 127.0.0.1
-- Tempo de geração: 26-Out-2021 às 21:21
...
CREATE TABLE `admin` (
  `username` char(16) NOT NULL COMMENT 'Usuário do admin',
  `password` char(40) NOT NULL COMMENT 'Senha do admin'
...
CREATE TABLE `cidade` (
  `id` int(11) NOT NULL COMMENT 'Id da cidade',
  `nome` varchar(120) DEFAULT NULL COMMENT 'Nome da cidade',
  `estado` int(5) DEFAULT NULL COMMENT 'Estado'
...
CREATE TABLE `costcenter` (
  `id` int(11) UNSIGNED NOT NULL COMMENT 'Id do Centro de Custo',
  `name` varchar(80) NOT NULL COMMENT 'Nome do Centro de Custo'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Extraindo dados da tabela `costcenter`
--

INSERT INTO `costcenter` (`id`, `name`) VALUES
(25, 'Equipe de Branding'),
(26, 'Equipe de Consultoria'),
(21, 'Equipe de Design'),
(22, 'Equipe Digital'),
(23, 'Projeto Social - MarAzul');
...
CREATE TABLE `department` (
  `id` int(11) UNSIGNED NOT NULL COMMENT 'Id do Departamento',
  `costcenter_id` int(11) UNSIGNED NOT NULL COMMENT 'Centro de Custo do Departamento',
  `name` varchar(80) NOT NULL COMMENT 'Nome do Departamento'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `department` (`id`, `costcenter_id`, `name`) VALUES
(20, 22, 'Recursos Humanos'),
(21, 22, 'Setor Comercial'),
(22, 22, 'Setor Operacional'),
(24, 22, 'Financeiro'),
(25, 22, 'Administrativo'),
(29, 25, 'Financeiro'),
(30, 26, 'Financeiro'),
(31, 21, 'Financeiro'),
(32, 23, 'Financeiro');
...
CREATE TABLE `estado` (
  `id` int(11) NOT NULL COMMENT 'Id do estado',
  `nome` varchar(75) DEFAULT NULL COMMENT 'Nome do estado',
  `uf` varchar(5) DEFAULT NULL COMMENT 'UF'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `position` (
  `id` int(11) UNSIGNED NOT NULL COMMENT 'Id do Cargo',
  `name` varchar(80) NOT NULL COMMENT 'Nome do Cargo'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `user` (
  `id` int(11) UNSIGNED NOT NULL COMMENT 'ID do usuário',
  `position_id` int(11) UNSIGNED NOT NULL COMMENT 'Cargo do Usuário',
  `department_id` int(11) UNSIGNED NOT NULL COMMENT 'Departamento do Usuário',
  `costcenter_id` int(11) UNSIGNED NOT NULL COMMENT 'Centro de Custo do Usuário',
  `name` varchar(80) NOT NULL COMMENT 'Nome do usuário',
  `passwd` char(40) NOT NULL COMMENT 'Senha do usuário',
  ...
  `bairro` varchar(100) NOT NULL COMMENT 'Bairro do usuário',
  `cep` varchar(10) NOT NULL COMMENT 'CEP do usuário',
  `estado` varchar(2) NOT NULL COMMENT 'Estado do usuário',
  `cidade` varchar(100) NOT NULL COMMENT 'Cidade do usuário',
  `telefone` varchar(15) DEFAULT NULL COMMENT 'Telefone do usuário',
  `telefone2` varchar(15) DEFAULT NULL COMMENT 'Telefone do usuário',
  `celular` varchar(15) NOT NULL COMMENT 'Celular do usuário',
  `celular2` varchar(15) DEFAULT NULL COMMENT 'Celular do usuário',
  `informacoes_adicionais` varchar(255) DEFAULT NULL COMMENT 'Informações adicionais'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `user` (`id`, `position_id`, `department_id`, `costcenter_id`, `name`, `passwd`, `email`, `endereco`, `complemento`, `bairro`, `cep`, `estado`, `cidade`, `telefone`, `telefone2`, `celular`, `celular2`, `informacoes_adicionais`) VALUES
(21, 20, 29, 22, 'José da Silva', '7c4a8d09ca3762af61e59520943dc26494f8941b', 'emersonbsi@outlook.com', 'Rua João Batista, 5552', 'Casa', 'São Félix', '22.222-223', '21', '4364', '19-2222-2222', '19-9999-9999', '19-98888-8888', '19-97777-7777', 'Informações adicionais'),
(22, 13, 30, 26, 'Mauro Sérgio', '7c4a8d09ca3762af61e59520943dc26494f8941b', 'emersonbsi@outlook.com.br', 'Rua João Batista, 555', 'Casa', 'Benguela', '22.222-222', '16', '3198', '19-8888-8888', '18-6666-6666', '19-94444-4444', '19-96666-6666', 'Mais informações'),
(23, 24, 32, 23, 'Castro Neves', '7c4a8d09ca3762af61e59520943dc26494f8941b', 'emersonbsi@ole.com.ar', 'Rua João Batista, 5559', 'Apartamento', 'Brás', '22.222-222', '19', '3608', '99-9999-9999', '88-8888-8888', '22-22222-2222', '44-44444-4444', 'Observações'),
(32, 13, 21, 22, 'Paulo', '42cfe854913594fe572cb9712a188e829830291f', 'paulo@gmail.com', 'Rua João Batista, 55594', 'Apartamento', 'Mararupá', '22.222-224', '20', '3698', '22-2222-2222', '33-3333-3333', '44-44444-4444', '55-55555-5555', 'Comentários');
...
ALTER TABLE `department`
  ADD PRIMARY KEY (`id`),
  ADD KEY `costcenter_id` (`costcenter_id`);
...
--
ALTER TABLE `cidade`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id da cidade', AUTO_INCREMENT=5565;

--
-- AUTO_INCREMENT de tabela `costcenter`
--
ALTER TABLE `costcenter`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Id do Centro de Custo', AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT de tabela `department`
--
ALTER TABLE `department`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Id do Departamento', AUTO_INCREMENT=33;

--
-- AUTO_INCREMENT de tabela `estado`
--
ALTER TABLE `estado`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id do estado', AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT de tabela `position`
--
ALTER TABLE `position`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Id do Cargo', AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT de tabela `user`
--
ALTER TABLE `user`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID do usuário', AUTO_INCREMENT=54;
...
--
ALTER TABLE `department`
  ADD CONSTRAINT `department_ibfk_1` FOREIGN KEY (`costcenter_id`) REFERENCES `costcenter` (`id`);
...
ALTER TABLE `user`
  ...
  ADD CONSTRAINT `user_ibfk_3` FOREIGN KEY (`costcenter_id`) REFERENCES `costcenter` (`id`);
COMMIT;
